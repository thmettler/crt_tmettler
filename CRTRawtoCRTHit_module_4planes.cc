...
void crt::CRTRawtoCRTHit::beginJob()
{
  ...
  if (infile.good()){
    getline(infile, input_temp1);
    getline(infile, input_temp2);
    getline(infile, input_temp3);
    getline(infile, input_temp4);
    std::cout << input_temp1 << std::endl;
    std::cout << input_temp2 << std::endl;
    std::cout << input_temp3 << std::endl;
    std::cout << input_temp4 << std::endl;
  }
  infile.close();
  std::cout <<input_temp1<< std::endl;
  std::cout <<input_temp2<< std::endl;
...
void crt::CRTRawtoCRTHit::make2DHit(){
  ...
  if(XY && coincidence[2].ts0!=0){
    ...
    td = abs((hit1_time_ns) - (hit2_time_ns));//in ns, corrected
